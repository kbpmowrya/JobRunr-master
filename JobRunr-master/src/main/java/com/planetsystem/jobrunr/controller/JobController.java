package com.planetsystem.jobrunr.controller;
...
import com.planetsystem.jobrunr.service.job.JobService;
...
public class JobController {
    ...
    @GetMapping(value = "/recurring-job")
    public String recurringJob(@RequestParam(value ="name", defaultValue = "simple") String name){
        final JobId enqueuedJobId = jobScheduler.enqueue(() -> jobService.doRecurringJob());
        return "Job Enqueued: " + enqueuedJobId;
    }    
